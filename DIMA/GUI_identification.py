...
class Identification_GUI(QWidget):
    ...
    def initUI(self):
        ...
        self.formLayout.addRow(self.deleteSelectedFilesBtn) 
        ...
        try: 
         ...
         # set it to Default scans in the input file if nothing is set
            ...
            for InputFilePath in self.InputFilePaths:
                ...
                analyzer = QueryTargetedSpectrum(InputFilePath)
                ...
                result_dicts = main_processing_function(lowerscan, higherscan, analyzer, library, PrecursorIonMassTolerance, ppm_tolerance, minmatchedpeaks, self.figPath)
